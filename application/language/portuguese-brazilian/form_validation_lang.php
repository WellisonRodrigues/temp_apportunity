...
$lang['form_validation_valid_date'] = "O campo %s nao é uma data válida(dd/mm/yyyy).";
$lang['form_validation_valid_date_menor'] = "O campo <b>{field}</b> deve ser menor que <b>{param}</b>.";
$lang['form_validation_valid_date_maior'] = "O campo <b>{field}</b> deve ser maior que <b>{param}</b>.";
$lang['form_validation_valid_cpf'] = "O campo %s nao é um cpf válido.";
