...
//echo '<br>';
foreach ($followed as $chave => $id) {

    $teste = array($chave => $id);
//    print_r($teste);

}
//echo '<br>';
$intersect = array_intersect($followed, $followers);
foreach ($intersect as $new_key => $ident_user) {
    $newvar[$new_key] = $ident_user['id'];
...
//                                        echo '<br>';
                                        ...
                                        $intersect_2 = array_intersect($newvar, $follow);
                                        $chave_unfollow = key($intersect_2);
                                        ?>
                                        <div class="col-md-4">
                                            <div class="jumbotron">
                                                <div class="text-center">
                                                    ...
                                                    <button type="button"
                                                            class="<?php echo $follow['id'] ?> <?php echo $class ?>"
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                $(".<?php echo $follow['id'] ?>").bind('click', function () {
                                                    var id = "<?php echo $chave_unfollow;?>";
                                                    var id_user = "<?php echo $follow['id'];?>";
                                                    var texto = $(".<?php echo $follow['id'] ?>").val();
//                                                    alert(texto);
//                                                    die();
                                                    $.post('follows_funtion/', {
                                                        ...
                                                        if (texto == 'Seguir') {
                                                            $(".<?php echo $follow['id'] ?>").removeClass("<?php echo $class?>");
                                                            $(".<?php echo $follow['id'] ?>").addClass("<?php echo $primary?>");
                                                            $(".<?php echo $follow['id'] ?>").html('Seguindo');
                                                            $(".<?php echo $follow['id'] ?>").val('Seguindo');
...
//
                                                        ...
                                                        if (texto == 'Seguindo') {
                                                            $(".<?php echo $follow['id'] ?>").removeClass("<?php echo $class?>");
                                                            $(".<?php echo $follow['id'] ?>").addClass("<?php echo $default?>");
                                                            $(".<?php echo $follow['id'] ?>").html('Seguir');
                                                            $(".<?php echo $follow['id'] ?>").val('Seguir');
                            ...
                            <div class="row">
                                <div class="result_follower">
                                    ...
                                    foreach ($followed as $key1 => $follow_as) {
                                            ...
                                            <div class="col-md-4">
                                                <div class="jumbotron">
                                                    <div class="text-center">
                                                        ...
                                                        <?php //echo $user['attributes']['age'] ?><!-- Anos</b><br>-->
                                                        <button type="button"
                                                                class="<?php echo $class ?> <?php echo $follow_as['id'] ?>"
                                                                value="<?php echo $texto ?>">
                                                            <?php echo $texto ?>
                                                        </button>
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                $(".<?php echo $follow_as['id'] ?>").bind('click', function () {
                                                    var id = "<?php echo $key1;?>";
                                                    var id_user = "<?php echo $follow_as['id'];?>";
                                                    var texto = $(".<?php echo $follow_as['id'] ?>").val();
//                                                    alert(texto);
//                                                    die();
                                                    $.post('follows_funtion/', {
                                                        iduser: id_user,
                                                        ...
                                                        if (texto == 'Seguir') {
                                                            $(".<?php echo $follow_as['id'] ?>").removeClass("<?php echo $class?>");
                                                            $(".<?php echo $follow_as['id'] ?>").addClass("<?php echo $primary?>");
                                                            $(".<?php echo $follow_as['id'] ?>").html('Seguindo');
                                                            $(".<?php echo $follow_as['id'] ?>").val('Seguindo');
...
//
                                                        ...
                                                        if (texto == 'Seguindo') {
                                                            $(".<?php echo $follow_as['id'] ?>").removeClass("<?php echo $class?>");
                                                            $(".<?php echo $follow_as['id'] ?>").addClass("<?php echo $default?>");
//                                                            $("#<?php //echo $follow_as['id'] ?>//").hide();
                                                            $(".<?php echo $follow_as['id'] ?>").html('Seguir');
                                                            $(".<?php echo $follow_as['id'] ?>").val('Seguir');
