 ...
 * Time: 18:32
 */
$this->fetchjob->setauthtoken($this->session->userdata('verify')['auth_token']);
        ...
        <div class="tab-pane active" id="tab_saved_jobs">
            ...
            if ($jobs) {
                foreach ($jobs as $job_salvo) {
                    ...
                    $image = $this->fetchjob->getcompanyimage();
                    if (!$image) {
                        ...
                        <div class="social-feed-box">
                            <div class="social-avatar">
                                ...
                                <div class="media-body">
                                    <a href="<?php echo base_url('Profiles/index/' . $this->fetchjob->getcompanyid() . '/' . $this->fetchjob->getcompanytype()) ?>">
                                        <?php
                                        echo $this->fetchjob->getcompanyname();
                                        ?>
                                    </a>
                                    <small class="text-muted"><?php echo date('d \of M', strtotime($this->fetchjob->getjobpublishedat())) ?>
                                    </small>
                                </div>
                            </div>
                            <div class="social-body">
                                <h4> <?php echo $this->fetchjob->gettitle() ?></h4>
                                <p>
                                    <?php echo $this->fetchjob->getdescription() ?>
                                    <br>
                                </p>
