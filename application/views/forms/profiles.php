...
//    print_r($dados['included'][0]);
    ...
    <div class="col-md-8 col-md-offset-2 col-sm-offset-1 col-sm-10">
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class=" text-center center-block">
                    <img src="<?php echo $dados['included'][0]['attributes']['image'] ?>" width="15%" height="15%"
                         class="img-circle">
                    <div class="row"><h4><strong><?php echo $dados['included'][0]['attributes']['name'] ?></strong>
                        </h4>
                    </div>
                    <div class="row"><h4>
                            <strong><?php echo $dados['included'][0]['attributes']['region'] ?></strong></h4>
                    </div>
                    <?php echo anchor('perfil_user/editar', 'Enviar mensagem', 'type="button" class="btn btn-primary"') ?>
                </div>
            </div>
            <div class="panel-body">
                ...
                <div class="row text-center">
                    ...
                    <div class="row">Email:
                        <strong><?php echo $dados['data']['attributes']['email'] ?></strong>
                        <div class="row">Idade:
                            <strong><?php echo $dados['included'][0]['attributes']['age'] ?></strong>
                        </div>
                    </div>
                </div>
            </div>
